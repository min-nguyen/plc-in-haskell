...
happyExpList = Happy_Data_Array.listArray (0,45) ([10640,256,0,7168,256,0,128,10640,23552,0,512,10640,10640,10640,0,0,0,10640,0,7200,10640,0,0
	])
...
action_19 (6) = happyShift action_20
